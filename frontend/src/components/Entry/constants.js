...
export const baseColumnsDef = [
  ...
  { header: 'Group', accessorKey: 'fresherGroup', id: 'fresherGroup', size: 140, minSize: 140, className: 'col-fresherGroup' },
...
export const optionalColumnsDef = [
  ...
  { header: 'Aadhaar Card Number', accessorKey: 'aadhaarNumber', id: 'aadhaarNumber', size: 180, minSize: 180, className: 'col-aadhaarNumber' },
...
export const MULTI_SORT_COLUMNS = [
  ...
  { id: 'fresherGroup', label: 'Fresher Group' },
